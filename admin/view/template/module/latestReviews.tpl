      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><input type="text" name="latestReviews_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="1" /></td>

            <td class="left"><input type="text" name="latestReviews_module[<?php echo $module_row; ?>][visible]" value="<?php echo $module['visible']; ?>" size="1" /></td>
            <td class="left">
                <select name="latestReviews_module[<?php echo $module_row; ?>][vertical]">
                    <?php if($module['vertical'] == 0) { ?>
            ...
            <td class="left">
                ...
                <?php } ?></td>
              <td class="left"><select name="latestReviews_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="latestReviews_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="left"><select name="latestReviews_module[<?php echo $module_row; ?>][status]">
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="latestReviews_module[' + module_row + '][limit]" value="5" size="1" /></td>';

    html += '    <td class="left"><input type="text" name="latestReviews_module[' + module_row + '][visible]" value="5" size="1" /></td>';

    html += '<td class="left">';
    html += '   <select name="latestReviews_module[<?php echo $module_row; ?>][vertical]">';
	...
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><select name="latestReviews_module[' + module_row + '][position]">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
	html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
	html += '    </select></td>';
	html += '    <td class="left"><select name="latestReviews_module[' + module_row + '][status]">';
